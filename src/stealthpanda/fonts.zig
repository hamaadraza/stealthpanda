...
const scales = std.StaticStringMap(f64).initComptime(.{
    ...
    // More macOS-preinstalled families a font-list probe checks, so more of them
    // read as *installed* (matching a real Mac's ~250-font set), not missing.
    .{ "arial hebrew", 1.008 },             .{ "arial rounded mt bold", 1.014 }, .{ "arial unicode ms", 1.007 },
    .{ "charter", 1.041 },                  .{ "din alternate", 0.976 },         .{ "din condensed", 0.842 },
    .{ "euphemia ucas", 1.026 },            .{ "galvji", 0.997 },                .{ "geeza pro", 1.130 },
    .{ "iowan old style", 1.048 },          .{ "kefa", 1.015 },                  .{ "luminari", 1.072 },
    .{ "marion", 1.037 },                   .{ "microsoft sans serif", 1.005 },  .{ "new peninim mt", 1.039 },
    .{ "pt mono", 1.106 },                  .{ "plantagenet cherokee", 1.028 },  .{ "seravek", 0.988 },
    .{ "silom", 1.102 },                    .{ "stixgeneral", 1.045 },           .{ "stix two math", 1.046 },
    .{ "superclarendon", 1.066 },           .{ "symbol", 1.090 },                .{ "thonburi", 1.135 },
    .{ "zapf dingbats", 1.200 },            .{ "krungthep", 1.032 },             .{ "sathu", 1.029 },
    .{ "ayuthaya", 1.030 },                 .{ "apple braille", 1.150 },         .{ "corsiva hebrew", 1.040 },
    .{ "raanana", 1.038 },                  .{ "sukhumvit set", 1.049 },         .{ "kohinoor devanagari", 1.142 },
});
